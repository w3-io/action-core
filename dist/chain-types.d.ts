...
export interface EvmSyscalls {
    "get-balance": {
        params: EvmGetBalanceParams;
        result: EvmGetBalanceResult;
    };
    "read-contract": {
    ...
    "transfer-token": {
        params: EvmTransferTokenParams;
        result: EvmReceipt;
    };
    "approve-token": {
        params: EvmApproveTokenParams;
        result: EvmReceipt;
    };
    "transfer-nft": {
        params: EvmTransferNftParams;
        result: EvmReceipt;
    };
    "get-transaction": {
